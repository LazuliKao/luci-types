...
declare namespace LuCI.tools.widgets {
  ...
  interface WidgetsModule {
    ...
    ZoneForwards: new (...args: unknown[]) => LuCI.form.DummyValue & IZoneForwards;
    IPSelect: new (...args: unknown[]) => LuCI.form.ListValue & IIPSelect;
    NetworkSelect: new (...args: unknown[]) => LuCI.form.ListValue & INetworkSelect;
    DeviceSelect: new (...args: unknown[]) => LuCI.form.ListValue & IDeviceSelect;
